package io.github.aquerr.pumpkinfever.client.model.layer;
...
public class RavenOnShoulderLayer<T extends Player> extends RenderLayer<T, PlayerModel<T>>
{
    ...
    public RavenOnShoulderLayer(RenderLayerParent<T, PlayerModel<T>> p_174511_, EntityModelSet p_174512_) {
        super(p_174511_);
        this.model = new RavenModel(p_174512_.bakeLayer(ModelLayers.PARROT));
    }
    ...
    private void render(PoseStack p_117318_, MultiBufferSource p_117319_, int p_117320_, T p_117321_, float p_117322_, float p_117323_, float p_117324_, float p_117325_, boolean p_117326_) {
        ...
        EntityType.byString(compoundtag.getString("id")).filter((p_117294_) -> {
            ...
            VertexConsumer vertexconsumer = p_117319_.getBuffer(this.model.renderType(RavenRenderer.TEXTURE_LOCATION));
